...
const D3 = () => {
  return (
    ...
    <div className="">
      ...
      {/* <div className="col-md-3 hc">dfdfffd</div>
      <div className="col-md-3 hc">dfdfffd</div>
      <div className="col-md-3 hc">dfdfffd</div> */}
